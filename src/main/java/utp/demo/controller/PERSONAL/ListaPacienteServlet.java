...
@WebServlet(name = "ListaPacienteServlet", urlPatterns = {"/ListaPacienteServlet"})
public class ListaPacienteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            request.getRequestDispatcher("/PERSONAL/registrar-paciente.jsp").forward(request, response);
        } catch (Exception e) {
            logger.warning("ERROR EN LA CLASE PERSONAL-ListaPacienteServlet: " + e);
        }
    }
}